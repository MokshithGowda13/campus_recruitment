                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" name="name" class="form-control" onclick="clearnamevalidation()" id="name" placeholder="Your Name">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="email" name="email" class="form-control" onclick="clearemailvalidation()" id="email" placeholder="Your Email">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <input type="text" name="subject" class="form-control" onclick="clearsubjectvalidation()" id="subject" placeholder="Subject">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <textarea class="form-control" name="message" onclick="clearmessagevalidation()" placeholder="Leave a message here" id="message" style="height: 150px"></textarea>
