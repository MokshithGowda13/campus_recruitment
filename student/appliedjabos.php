    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-5 bg-dark page-header mb-5">
            <div class="container my-5 pt-5 pb-4">
                <h1 class="display-3 text-white mb-3 animated slideInDown">Applied</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb text-uppercase">
                        <li class="breadcrumb-item"><a href="./home.php">Home</a></li>
                        <li class="breadcrumb-item text-white active" aria-current="page">Applied</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Applied</h1>
                <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.3s">
                    <div class="tab-content">
                    <div id="tab-1" class="tab-pane fade show p-0 active">
                            <?php  
                                $ID=$_SESSION['student_id'];
                                $query=mysqli_query($con,"SELECT apply_post.*,vacancy.* from vacancy,apply_post 
                                where apply_post.vacancy_id=vacancy.vacancy_id and apply_post.student_id=$ID") 
